...
%---------------------------------------------------------
    \cventry
    {Hardware developer} % Role
    {Bluetooth speaker met visualizer} % Project Title
    {} 
    {}
    {
      \begin{cvitems} % Beschrijving van project en rol
        \item {Dit project was een 6 maanden durend project waarbij ik een Bluetooth-luidspreker met een visualizer had gebouwd.}
        \item {Het project bestond uit het ontwerpen van PCB's, 3D-designs en een combinerend werkend systeem.}
        \item {Ik maakte gebruik van Arduino en C-code om de visualizer te programmeren.}
      \end{cvitems}
    }
